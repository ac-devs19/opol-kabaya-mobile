...
export default function Home() {
  ...
  const { data, refetch, isRefetching } = useQuery<LinkSystem[]>({
                ...
                item.is_active === 1 ? (
                  ...
                  >
                    <TouchableOpacity
                      onPress={() => {
                        const canAccess =
                          item.is_open === 1 || user?.is_verified === 1;
            ...
            {isLoadingNews ? (
              ...
              <View className="gap-4">
                {news[0] && (
                  <Pressable
                    onPress={() =>
                      router.navigate(`/news/article/${news[0].id}`)
                    }
                ...
                {news[1] && (
                  <Pressable
                    onPress={() =>
                      router.navigate(`/news/article/${news[1].id}`)
                    }
                    ...
                    <View className="flex-row">
                      ...
                      <View className="ml-3 flex-1 justify-between py-1">
                        ...
                        <View className="flex-row items-center justify-between">
                          ...
                          <Icon as={ArrowRight} size={14} strokeWidth={1.5} />
                        </View>
                      </View>
                    </View>
                  </Pressable>
                    ...
                    <View className="flex-row flex-wrap">
                      <View className="mb-3 w-1/2 pr-2">
                        <View className="rounded-2xl bg-background p-3.5">
                          ...
                          <Text className="mt-1 font-quicksand-bold text-xl">
                            {demographics.marital_status.single?.percentage ??
                              0}
                            %
                          </Text>
                      ...
                      <View className="mb-3 w-1/2 pl-2">
                        <View className="rounded-2xl bg-background p-3.5">
                          ...
                          <Text className="mt-1 font-quicksand-bold text-xl">
                            {demographics.marital_status.married?.percentage ??
                              0}
                            %
                          </Text>
                          <Text className="mt-0.5 font-quicksand-medium text-[9px] text-muted-foreground">
                      ...
                      <View className="w-1/2 pr-2">
                        <View className="rounded-2xl bg-background p-3.5">
                          ...
                          <Text className="mt-1 font-quicksand-bold text-xl">
                            {demographics.marital_status.widowed?.percentage ??
                              0}
                            %
                          </Text>
                          <Text className="mt-0.5 font-quicksand-medium text-[9px] text-muted-foreground">
                      ...
                      {(demographics.marital_status.separated?.count ?? 0) >
                        ...
                        <View className="mt-3 w-full">
                          <View className="rounded-2xl bg-background p-3.5">
                            ...
                            <Text className="mt-0.5 font-quicksand-medium text-[9px] text-muted-foreground">
                              {(
                                demographics.marital_status.separated?.count ??
                                0
                              ).toLocaleString()}{" "}
                              residents
                            </Text>
